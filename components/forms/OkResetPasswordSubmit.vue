    ...
    <div class="has-text-centered has-padding-20 ok-has-text-primary-invert" @submit.prevent="onSubmit">
        <div v-if="requestInProgress">
            ...
            <div class="content">
                ...
                <p>
                    {{ $t('global.snippets.were_changing_your_password') }}
                </p>
            </div>
        </div>
        <div v-else-if="hasError">
            ...
            <div class="content">
                ...
                <p>
                    {{ $t('global.snippets.we_couldnt_change_your_password') }}
                </p>
                <p>
...
<script lang="ts">
    ...
    @Component({
        name: "OkResetPasswordSubmit",
        components: {OkButtonsNavigation}
    })
    export default class OkResetPasswordSubmit extends Vue {
        ...
        registrationOperation?: CancelableOperation<void> | undefined;
        ...
        async registerUser() {
            ...
            try {
                ...
                this.$emit("onResetPasswordRequested", registrationData);
