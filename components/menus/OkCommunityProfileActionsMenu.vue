                ...
                <div class="media columns is-vcentered">
                    <div class="column">
                        <div class="media-content">
                            ...
                            <p class="subtitle is-6 ok-has-text-primary-invert-80">Change your communityname, name, url, location, avatar or cover photo.</p>
                        </div>
                    </div>
...
<script lang="ts">
    ...
    export default class OkCommunityProfileActionsMenu extends Vue {
